...
<body style="background-color=red;">
	...
	<form method="get">
		...
		<br>
		<br>
		Jumlah Positif : <input type="text" name="jmlPositif">
		<br>
		<br>
		Jumlah Dirawat : <input type="text" name="jmlDirawat">
		<br>
		<br>
		Jumlah Sembuh : <input type="text" name="jmlSembuh">
		<br>
		<br>
		Jumlah Meninggal : <input type="text" name="jmlMeninggal">
		<br>
		<br>
